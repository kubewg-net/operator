...
// Package v1alpha1 contains API Schema definitions for the kubewg v1alpha1 API group
...
var (
	...
	GroupVersion = schema.GroupVersion{Group: "kubewg.mcswain.dev", Version: "v1alpha1"}
