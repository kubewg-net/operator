...
// _ "k8s.io/client-go/plugin/pkg/client/auth" is to import all
// Kubernetes client auth plugins (e.g. Azure, GCP, OIDC, etc.)
...
func init() {
	...
	utilruntime.Must(kubewgmcswaindevv1alpha1.AddToScheme(scheme))
